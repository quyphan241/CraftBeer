...
describe('BeerCategory Management Component', () => {
  let comp: BeerCategoryComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(BeerCategoryComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.beerCategories[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
